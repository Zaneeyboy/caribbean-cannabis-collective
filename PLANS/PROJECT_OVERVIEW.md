...
> "I'm trying to put together the Caribbean Cannabis Collective site with an online store for merchandise only right now — t-shirts, hats, buckler beers, sleeves, things like that. I'm trying to do a
> US and Caribbean drop site, so where we could ship to within the Caribbean, and I'll have my guys in New York and Miami ship throughout the US."
